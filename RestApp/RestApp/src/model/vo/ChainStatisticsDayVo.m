...
#import "ChainStatisticsDayVo.h"
#import "ObjectUtil.h"
@implementation ChainStatisticsDayVo
- (id)initWithDictionary:(NSDictionary *)dic{
    
    if (self = [super init]) {
        self.businessDate = [ObjectUtil getStringValue:dic key:@"businessDate"];
