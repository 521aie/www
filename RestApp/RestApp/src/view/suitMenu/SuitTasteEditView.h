...
@class MenuModule,NavigateTitle2,EditItemText,EditItemRadio,EditItemView,MBProgressHUD,FooterListView;
@class Taste,KindTaste;
@interface SuitTasteEditView : UIViewController<INavigateEvent,FooterListEvent,UIActionSheetDelegate>{
    MenuModule *parent;
    MBProgressHUD *hud;
}
...
@property (nonatomic, weak) IBOutlet UITextView *lblTip;
