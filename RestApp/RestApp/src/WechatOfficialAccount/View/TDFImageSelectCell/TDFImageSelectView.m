...
@implementation TDFImageSelectView
...
- (UIButton *)addButton {
    ...
    if (!_addButton) {
        ...
        [_addButton setImage:[UIImage imageNamed:@"wxoa_image_select_add"] forState:UIControlStateNormal];
...
- (UIButton *)deleteButton {
    ...
    if (!_deleteButton) {
        ...
        [_deleteButton setImage:[UIImage imageNamed:@"ico_remove"] forState:UIControlStateNormal];
...
- (UILabel *)errorLabel {
    ...
    if (!_errorLabel) {
        ...
        _errorLabel.textColor = [UIColor colorWithHeX:0xCC0000];
...
- (UILabel *)promptLabel {
    ...
    if (!_promptLabel) {
        ...
        _promptLabel.textColor = [UIColor colorWithHeX:0x999999];
