...
- (UIButton *)selectButton {
    if (_selectButton == nil) {
        ...
        [_selectButton setImage:[UIImage imageNamed:@"ico_check"] forState:UIControlStateSelected];
        [_selectButton setImage:[UIImage imageNamed:@"ico_uncheck"] forState:UIControlStateNormal];
    }
